            ...
            <div className="relative z-10 py-24">
                <div className="mx-auto w-full max-w-5xl px-6">
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            className="overflow-hidden p-6 bg-black/50 border-white/10 backdrop-blur-sm">
                        ...
                        <Card
                            className="group overflow-hidden px-6 pt-6 bg-black/50 border-white/10 backdrop-blur-sm">
